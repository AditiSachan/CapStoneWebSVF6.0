// // // CompileOptionsMenu.tsx - With tooltips for selected values
...
// // import { compileOptionDescriptions } from '../../tooltip/tooltipDescriptions';
// // import { CompileOption, addDescriptionsToOptions } from '../../tooltip/optionTypes';
...
// //     label: string;
// //   }[];
// //   setSelectedCompileOptions: (selectedCompileOptions: any[]) => void;
...
// //   // Enhance the currently selected options with descriptions too
// //   const selectedOptionsWithDescriptions = selectedCompileOptions.map(option => {
// //     const matchingOption = optionsWithDescriptions.find(o => o.value === option.value);
// //     return matchingOption || option;
// //   });

// //   const handleChange = (selected: MultiValue<CompileOption>) => {
// //     setSelectedCompileOptions(selected ? Array.from(selected) : []);
// //   };
...
// // CompileOptionsMenu.tsx - Updated with ChatGPT integration
// import React from 'react';
// import Select, { MultiValue, ActionMeta } from 'react-select';
// import makeAnimated from 'react-select/animated';
// import CustomOption from '../../tooltip/customOption';
...
//       menuPortalTarget={document.body}
//       menuPosition={'fixed'}
//       name="compileOptions" // Added name to identify component type
//     />
//   );
// };
